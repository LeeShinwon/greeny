...
final itemContent =[
  "개인이나 단체가 음식을 버리는 대신 공유하는 것입니다. 독일의 영화제작자이자 저널리스트인 발렌틴 투른이 자신의 다큐멘터리 '쓰레기를 맛보자(Taste the Waste)'를 통해 음식물 쓰레기를 줄이자는 캠페인을 벌이며 시작되었습니다. 현재 약 240개 도시에 냉장고나 선반을 설치해 음식을 나누고 있습니다.",
